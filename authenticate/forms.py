...
# This is a class that will enable us to sign up
...
#This class will enable us to edit our Profile
class EditProfileForm(UserChangeForm):
    class Meta:
        password = forms.CharField(label = "", widget =forms.TextInput(attrs={'type': 'hiden'}))
        model = User
